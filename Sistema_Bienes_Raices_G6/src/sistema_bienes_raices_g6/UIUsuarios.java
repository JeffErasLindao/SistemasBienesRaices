...
/**
 * Clase del cual se crean las variables estaticas, en este caso las listas, ya que
 * no cambiaran a lo largo del programa, e interacciona con les menus mostrados por cada
 * una de las clases que se llaman respectivamente.
 * @author andya
 */
public class UIUsuarios {
    ...
    public UIUsuarios(){ 
        ...
        Usuario ag2= new Agente_Venta("pedrin_07", "12345", "Pedro Santana", 0704541212, "pedri17@gmail.com", 2);
        ...
        do{
            ...
            //y dependiendo de esto muestra los menus correspondientes
                case 1:
                    ...
                    boolean flag=true;
                     while (userSystem == null && flag) { //--> entra al bucle si el usuario no coincide con ninguno de la lista
                        System.out.println("\nEl usuario o constrasenia son invalidas...");
                        System.out.print("¿Desea continuar el logging....<s/n>?: ");
                        scLog.reset();
                        String respuesta = scLog.nextLine();
                ...
                case 2:
                    System.out.print("Igrese su edad:");
                        ...
                        if(edad<18){
                            ...
                            Usuario nuevoCliente = new Cliente(userCliente,passwordCliente,nombreCliente,cedulaCliente,correoCliente,null);
