...
/**
 * Sub-clase de Usuario,se comporta cmo cliente, dandole opcion a mostrar los menus
 * correspondientes a su tipo, y metodos propios de cliente.
 * @author andya
 */
public class Cliente extends Usuario{
    private static ArrayList<Consulta> ListaConsultas;
    ...
    private static void opcion2C(){
        ...
        if(consul==1){
            ...
            while(!sc.hasNextInt()){
                ...
                System.out.print("Ingrese el id de la propiedad para seguir la consulta: ");
            }
        ...
        for (Consulta c: UIUsuarios.getListaConsultas()){
            if(c!=null){
                if(c.getCodigo()== codigo){
                        ...
                        String respuesta = scQ.nextLine();
                        if(respuesta.toLowerCase().equals("si")){
                        System.out.print("\nIngrese la pregunta: ");
                        String pregunta = scQ.nextLine();
                        LocalDate fechapreg = LocalDate.now();
                        Conversacion nuevo_mss  = new Conversacion(fechapreg, pregunta);
                        //con.getConversaciones().add(nuevo_mss);
                        c.anadirConversacion(nuevo_mss);
                    }
                }
            
            }//-->Entra si no esta vacia
            
        }//--> FIN DEL FOR DE ListConsultas
            
        
        }//--> FIN DEL IF ENTRA CUANDO ExISTE AL MENOS UNA CONSULTA
    }
